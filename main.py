...
def get_main_args():
    ...
    path_args.add_argument('--dataset_dir', type=str, default='data/rz_centerscore_dataset',
                           help='Directory to save/load the processed PyG dataset.')
    path_args.add_argument('--model_save_path', type=str, default='trained_models/center_scorer_model.pt',
